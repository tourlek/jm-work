<template>
  <div class="flex h-screen">
    ...
    >
      ...
      >
        <div class="cursor-pointer m-auto" @click="toggleCollapse">
          <svg
        ...
        <br />
        <div class="flex-grow menu rounded-box p-0 w-full">
          <li>
            <router-link to="/home">
              <div>
                <svg
              ...
              <div v-if="!isCollapsed" class="hidden sm:inline">Home</div>
            </router-link>
          </li>
          <li>
            <router-link to="/list-employee">
              ...
              <div v-if="!isCollapsed" class="hidden sm:inline">List</div>
            </router-link>
          </li>
        </div>
...
let isLinkActive = (routePath) => route.path === routePath;
...
const toggleCollapse = () => {
  ...
  // Adjust the width of the aside element when the collapsible button is clicked
  const asideElement = document.querySelector("aside");
  if (asideElement) {
    asideElement.style.width = isCollapsed.value ? "65px" : "148px";
  }
};
